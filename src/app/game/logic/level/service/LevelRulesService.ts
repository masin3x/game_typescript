...
export class LevelRulesService {
  private readonly rules: Map<Levels, LevelRules> = new Map([
    [
      Levels.ONE,
      {
  ...
  getAllRules(): Map<Levels, LevelRules> {
    return this.rules;
  }

  getRulesByLevel(levels: Levels): LevelRules | null {
    return this.rules.get(levels) || null;
  }
}
