...
import { TextureAIDs } from "../../../display/graphics/enum/TextureAIDs";
...
export class ItemService extends StateHandlerServiceBase {
  ...
  private readonly levelRulesService: LevelRulesService = Container.resolve(LevelRulesService);
  ...
  refresh(scalar: number): ItemFrame {
    ...
    const levelRules = this.levelRulesService.getRulesByLevel(state.level);
