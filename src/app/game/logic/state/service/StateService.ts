...
export class StateService {
  ...
  constructor(dimensions: Dimensions, statusActions: Map<Statuses, () => void>) {
    ...
    this.state = this.createState(dimensions);
  ...
  private createState(dimensions: Dimensions): State {
